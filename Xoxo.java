...
public class Xoxo {
	...
	public static void main(String[] args) {
        ...
        byte verticalValue;
        boolean gameContinue = true; //необходимость продолжени€ игры
        ...
        while (gameContinue){
        	...
        	//¬водим координаты клеточки, куда ставим крестик или нолик
        	...
        	//¬ысчитываем контрольные суммы победы
        	...
        	//ѕровер€ем наличие победы или ничьей
